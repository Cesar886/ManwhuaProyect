...
function CustomPagination({ value, onChange, total }) {
...
export default function NsfwClient({ initialSeries = [], lang = 'es' }) {
      ...
      <div style={{
        ...
        <div id="nsfw-ia-wrap" style={{ position: 'relative' }}>
          ...
          >
              ...
              <span className={classes.paypalLabel}>{lang === 'en' ? 'Like AI? Support us to keep it running' : '¿Te gusta la IA? Apóyanos para mantenerla'}</span>
