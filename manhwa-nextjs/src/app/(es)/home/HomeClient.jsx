  ...
  return (
    <div className={styles.pageWrapper}>
      <main className={styles.content}>
        ...
        {/* ================================================================== */}
        {/* ANUNCIO CANAL WHATSAPP - Banner personal del creador              */}
        {/* ================================================================== */}
        <a
          href="https://whatsapp.com/channel/0029VbD6LWlC6Zvhn5YyfA0S"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.whatsappBanner}
          aria-label="Únete al canal de WhatsApp de Manhwa Imperial"
        >
          <div className={styles.whatsappBannerGlow} aria-hidden="true" />
          <div className={styles.whatsappBannerLeft}>
            <div className={styles.whatsappIconWrap} aria-hidden="true">
            ...
            <div className={styles.whatsappBannerText}>
              <span className={styles.whatsappBannerTitle}>¡Únete a nuestro canal de WhatsApp!</span>
              <span className={styles.whatsappBannerSub}>Recibe novedades, capítulos nuevos y recomendaciones directamente en tu móvil</span>
            </div>
          </div>
          <span className={styles.whatsappBannerCta}>
            Unirme
