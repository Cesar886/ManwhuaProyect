        ...
        {heroTotal > 0 && (
          ...
          >
            ...
            {heroCover && !isSurpriseSlide && (
              <div className={styles.heroBgLayers} style={{ '--hero-cover': `url(${heroCover})` }}>
                <div className={styles.heroBgBlur} />
                <div className={styles.heroBgGlow} />
                <div className={styles.heroBgSpot} />
              </div>
            )}
...
{/* ================================================================== */}
        {/* ANUNCIO JOINGROUPS - Directorio de Grupos y Clanes                 */}
        {/* ================================================================== */}
        <a
          href="https://www.joingroups.lat/"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.promoBanner}
          aria-label="Encuentra o publica grupos de WhatsApp, Telegram y clanes en JoinGroups"
        >
          <div className={styles.promoBannerGlow} aria-hidden="true" />
          <div className={styles.promoBannerLeft}>
            <div className={styles.promoIconWrap} aria-hidden="true">
              {/* Ícono representativo de comunidades/grupos */}
            ...
            <div className={styles.promoBannerText}>
              <span className={styles.promoBannerTitle}>¡Descubre las mejores comunidades!</span>
              <span className={styles.promoBannerSub}>Únete o publica grupos de WhatsApp, Telegram y clanes de Clash Royale</span>
            </div>
          </div>
