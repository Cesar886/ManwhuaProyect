...
export default function MangasClient({ initialSeries = [] }) {
                ...
                {isLoading && (
                    <Stack gap="md">
                        <Group>
                            ...
                            <Text size="xl" fw={700}>Cargando catálogo de Manga...</Text>
                        </Group>
                            ...
                            <Stack gap="sm">
                                <Group ref={gridTopRef} justify="space-between">
                                    <Group gap="xs">
                                        ...
                                        <Text size="lg" fw={700}>Catálogo de Manga</Text>
                                    </Group>
                                    <Text size="xs" c="dimmed">{filteredSeries.length} mangas disponibles</Text>
                                </Group>
                                            ...
                                            <Link href={`/manhwa/${series.slug}`} className={classes.releaseCoverContainer}>
                                                <div className={classes.releaseCoverWrapper}>
                                                    ...
                                                    <ManhwaCover
                                                        ...
                                                        slug={series.slug}
                                                        alt={`Portada del manga ${series.title} - Leer en español online gratis en Manhwa Imperial`}
                                ...
                                {(styles) => (
                                    <Card p="xl" radius="lg" bg="rgba(255,255,255,0.02)" style={{ ...styles, textAlign: 'center', border: '1px dashed var(--border-subtle)' }}>
                                        <Stack align="center" gap="sm">
                                            <Text fw={600}>No se encontraron mangas</Text>
